            ...
            <div className="toolbar">
                ...
                <div className="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
                    ...
                    <div className="page-title d-flex flex-column me-5">
                        {/*begin::Title*/}
                        <h1 className="d-flex flex-column text-dark fw-bolder fs-3 mb-0">Projects</h1>
                        {/*end::Title*/}
                        {/*begin::Breadcrumb*/}
                        <ul className="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
                            {/*begin::Item*/}
                            <li className="breadcrumb-item text-muted">
                                <a href="../../demo8/dist/index.html" className="text-muted text-hover-primary">Home</a>
                            </li>
                            {/*end::Item*/}
                            {/*begin::Item*/}
                            ...
                            {/*end::Item*/}
                            {/*begin::Item*/}
                            <li className="breadcrumb-item text-dark">Projects</li>
                            {/*end::Item*/}
                        </ul>
                        {/*end::Breadcrumb*/}
                    </div>
